with subsource_cte as (
 ...
 subsource_id_cte as (
        ...
        from googleads_raw.ad_performance_report
        group by 1,2
...
campaign_max_updated_date as (
 ...
 from googleads_raw.campaign_history 
 group by 1
),
...
campaign_types as (
 ...
 LEFT JOIN googleads_raw.campaign_history 
...
joined_data as  ( (  
        ...
        SELECT  ad_final_urls,
                ...
                account_id, 
                campaign_status
        FROM reporting.erie_googleads_campaign_performance
        left join (
        ...
        from reporting.erie_googleads_campaign_performance) t 
