...
SELECT 
        ...
        END as erie_type,
        CASE WHEN ((campaign_name ~* 'All Area' and (account_id = '813620678687014' OR account_id = '306770030564777') ) or ((campaign_name ~* 'sandbox' or campaign_name ~* 'All Area') and account_id = '1349056908916556')) AND campaign_name !~* 'Region' THEN 'National'
             WHEN campaign_name ~* 'Region' THEN 'Regional'     
