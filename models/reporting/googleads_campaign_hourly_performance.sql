...
(SELECT date, hour, campaign_name, campaign_id, 'Basement' as erie_type, 
  ...
  GROUP BY 1,2,3,4,5
  UNION ALL
  SELECT date, hour, campaign_name, campaign_id, CASE WHEN customer_id = 4560674777 THEN 'Roofing' WHEN customer_id = 2819798401 THEN 'Basement' ELSE 'Unmapped' END as erie_type, 
